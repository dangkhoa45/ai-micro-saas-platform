...
-- CreateIndex
CREATE INDEX "Project_appId_idx" ON "Project"("appId");
...
-- CreateIndex
CREATE INDEX "UsageLog_appId_idx" ON "UsageLog"("appId");
...
-- AddForeignKey
ALTER TABLE "UsageLog" ADD CONSTRAINT "UsageLog_appId_fkey" FOREIGN KEY ("appId") REFERENCES "App"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
